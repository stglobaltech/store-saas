...
import { S_CHEF_ORDER_SUBSCRIPTION } from "graphql/subscriptions/order-status.subscription";
...
const OrderStatusSubscriptionWrapper = (orderId) => {
  const res = useSubscription(S_CHEF_ORDER_SUBSCRIPTION, {
    variables: {
      input: {
