...
const EditCoupon: React.FC<Props> = (props) => {
  ...
  const [offer, setOffer] = useState({
    ...
    discountIn: [{ value: item.discountIn, label: item.discountIn }],
    discountType: [{ value: item.discountType, label: item.discountType }],
    discountUnit: [{ value: item.discountUnit, label: item.discountUnit }],
    ...
    <>
      ...
      <Form onSubmit={handleSubmit(onSubmit)} style={{ height: '100%' }}>
        ...
        >
          ...
          {/* TODO: Change value offers to offer in ln 572 */}
        ...
        <ButtonGroup>
          ...
          <Button
            type="submit"
            disabled={offer.imageLoader || updating}
            overrides={{
              BaseButton: {
                style: ({ $theme }) => ({
                  width: '50%',
